...
cap = cv2.VideoCapture('/Users/aaronraja/Desktop/python/car detection/traffic.mp4')
car_cascade = cv2.CascadeClassifier('/Users/aaronraja/Desktop/python/car detection/cars.xml')
